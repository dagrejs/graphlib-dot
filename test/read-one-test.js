...
describe("read", function() {
  ...
  describe("nodes", function() {
    ...
    it("can read escaped quotes", function() {
      expect(read("digraph { \"\\\"a\\\"\" }").nodeIds()).to.eql(["\"a\""]);
    });

    it("preserves non-quote escapes", function() {
      expect(read("digraph { \"foo\\-bar\" }").nodeIds()).to.eql(["foo\\-bar"]);
    });
  ...
  describe("subgraphs", function() {
    it("ignores empty subgraphs", function() {
      expect(read("digraph { subgraph X {} }").nodeIds()).to.be.empty;
      expect(read("digraph { subgraph {} }").nodeIds()).to.be.empty;
      expect(read("digraph { {} }").nodeIds()).to.be.empty;
    });
